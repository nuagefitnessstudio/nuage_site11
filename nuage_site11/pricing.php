  ...
  <div class="container" style="max-width:1200px;margin:auto;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:24px;">
      ...
      <div style="background:#fff;border-radius:16px;padding:32px;box-shadow:0 6px 20px rgba(0,0,0,0.08);">
        ...
        <a href="https://app.glofox.com/portal/#/branch/6765827de166ca71d60bd4e8/classes-day-view" target="_blank" rel="noopener" class="btn btn-primary">Choose Bronze</a>
      </div>
      ...
      <div style="background:#fff;border-radius:16px;padding:32px;box-shadow:0 6px 20px rgba(0,0,0,0.08);">
        ...
        <a href="https://app.glofox.com/portal/#/branch/6765827de166ca71d60bd4e8/classes-day-view" target="_blank" rel="noopener" class="btn btn-primary">Choose Silver</a>
      </div>
      ...
      <div style="background:#fff;border-radius:16px;padding:32px;box-shadow:0 6px 20px rgba(0,0,0,0.08);">
        ...
        <a href="https://app.glofox.com/portal/#/branch/6765827de166ca71d60bd4e8/classes-day-view" target="_blank" rel="noopener" class="btn btn-primary">Choose Gold</a>
      </div>
    </div>
  </div>
</section>
...
<section class="hero-ot" style="min-height:40vh">
    <div class="hero-inner">
      ...
      <p>Month-to-Month Contract • 30-Day Cancellation</p>
      <div class="cta-row">
        <a class="btn btn-primary" href="https://app.glofox.com/portal/#/branch/6765827de166ca71d60bd4e8/classes-day-view" target="_blank" rel="noopener">View Classes</a>
        <a class="btn btn-light" href="index.php">Back Home</a>
      </div>
    </div>
</section>
  ...
  <div class="container" style="max-width:1200px;margin:auto;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:24px;">
      ...
      <div style="background:#fff;border-radius:16px;padding:32px;box-shadow:0 6px 20px rgba(0,0,0,0.08);">
        ...
        <a href="https://app.glofox.com/portal/#/branch/6765827de166ca71d60bd4e8/classes-day-view" target="_blank" rel="noopener" class="btn btn-primary">Choose Intro</a>
      </div>
      ...
      <div style="background:#fff;border-radius:16px;padding:32px;box-shadow:0 6px 20px rgba(0,0,0,0.08);">
        ...
        <a href="https://app.glofox.com/portal/#/branch/6765827de166ca71d60bd4e8/classes-day-view" target="_blank" rel="noopener" class="btn btn-primary">Choose Bronze PT</a>
      </div>
      ...
      <div style="background:#fff;border-radius:16px;padding:32px;box-shadow:0 6px 20px rgba(0,0,0,0.08);">
        ...
        <a href="https://app.glofox.com/portal/#/branch/6765827de166ca71d60bd4e8/classes-day-view" target="_blank" rel="noopener" class="btn btn-primary">Choose Silver PT</a>
      </div>
      ...
      <div style="background:#fff;border-radius:16px;padding:32px;box-shadow:0 6px 20px rgba(0,0,0,0.08);">
        ...
        <a href="https://app.glofox.com/portal/#/branch/6765827de166ca71d60bd4e8/classes-day-view" target="_blank" rel="noopener" class="btn btn-primary">Choose Gold PT</a>
      </div>
      ...
      <div style="background:#fff;border-radius:16px;padding:32px;box-shadow:0 6px 20px rgba(0,0,0,0.08);">
        ...
        <a href="https://app.glofox.com/portal/#/branch/6765827de166ca71d60bd4e8/classes-day-view" target="_blank" rel="noopener" class="btn btn-primary">Choose Add-On</a>
      </div>
    </div>
  </div>
</section>
