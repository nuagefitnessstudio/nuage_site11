...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box} html,body{height:100%}
    ...
    .btn{border-radius:12px; padding:14px 22px; font-weight:600; letter-spacing:.08em; display:inline-block; border:1px solid transparent; text-align:center}
    .btn-primary{background:var(--navy); color:#fff; border-color:var(--navy)}
    .btn-light{background:#fff; color:#16223a; border-color:#eee}
    .plan{background:#fff; border:1px solid var(--line); border-radius:1rem; padding:1.25rem; display:flex; flex-direction:column; justify-content:space-between}
    .plan h3{margin:.25rem 0; color:var(--navy); font-size:1.5rem}
  </style>
</head>
<body>
