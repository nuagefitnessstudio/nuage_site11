...
<div style="margin-top:24px; text-align:center;">
  ...
  <div class="social-follow">
    <style>
      ...
      .social-icons { display:flex; justify-content:center; gap:22px; margin-top:8px; }
      .social-icons a { display:flex; align-items:center; justify-content:center; width:44px; height:44px; border-radius:9999px; color: var(--navy,#0b2a4a); background: rgba(255,255,255,0.9); box-shadow: 0 2px 6px rgba(0,0,0,0.08); transition: all .25s ease; }
      .social-icons a:hover { color:#fff; background: var(--coral,#e92e53); transform: translateY(-2px); box-shadow: 0 4px 12px rgba(233,46,83,0.28); }
      .social-icons svg { width:22px; height:22px; }
      .social-follow .hint { font-size:14px; color: var(--muted,#6b7280); margin-top:4px; }
    </style>
    <div class="hint">Click an icon below to connect with us</div>
    <div class="social-icons">
      <a href="https://www.instagram.com/nuage_fitness_studio?igsh=MWFoeXB4OXc5NDJuZg%3D%3D&utm_source=qr" target="_blank" rel="noopener" aria-label="Visit our Instagram">
        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M7 2h10a5 5 0 015 5v10a5 5 0 01-5 5H7a5 5 0 01-5-5V7a5 5 0 015-5zm0 2a3 3 0 00-3 3v10a3 3 0 003 3h10a3 3 0 003-3V7a3 3 0 00-3-3H7zm5 3.5A5.5 5.5 0 116.5 13 5.5 5.5 0 0112 7.5zm0 2A3.5 3.5 0 1015.5 13 3.5 3.5 0 0012 9.5zm6-3a1 1 0 11-1 1 1 1 0 011-1z"/></svg>
      </a>
      <a href="https://www.facebook.com/profile.php?id=61583193395222#" target="_blank" rel="noopener" aria-label="Visit our Facebook">
        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M13.5 22v-7h2.5l.5-3h-3V9.5c0-.9.3-1.5 1.7-1.5H16V5.3c-.3 0-1.3-.1-2.3-.1-2.2 0-3.7 1.3-3.7 3.8V12H7.5v3h2.5v7h3.5z"/></svg>
      </a>
    </div>
  </div>
