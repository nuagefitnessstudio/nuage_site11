...
#employmentModal .nuage-modal{width:min(640px,92vw); max-height:75vh; display:flex; flex-direction:column; overflow:hidden; border-radius:14px; background:#fff; box-shadow:0 20px 60px rgba(0,0,0,.25);}
#employmentModal .nuage-modal>header{padding:12px 16px; font-weight:700; background:#0c2a68; color:#fff;}
#employmentModal form.content{padding:14px 16px; overflow-y:auto; flex:1;}
#employmentModal .nuage-actions{position:sticky; bottom:0; padding:10px 16px; border-top:1px solid #eee; background:#fff; display:flex; gap:10px; justify-content:flex-end;}
#employmentModal .row{display:grid; grid-template-columns:1fr 1fr; gap:12px;}
@media (max-width:640px){#employmentModal .row{grid-template-columns:1fr;}}
#employmentModal fieldset{border:1px solid #e5e7eb; border-radius:8px; padding:8px 10px; max-height:160px; overflow:auto;}
