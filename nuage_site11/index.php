...
<body>
  ...
  <aside class="drawer" id="navDrawer" hidden aria-hidden="true">
    <div class="drawer-header">
      <div class="brand">
        <img loading="lazy" src="assets/IMG_2413.png" alt="NuAge logo">
        <div class="brand-name">NuAge<span>Fitness</span><span>Studios</span></div>
      </div>
  ...
  <section class="split" data-reveal>
    <div class="visual"><img loading="lazy" referrerpolicy="no-referrer" class="remote" src="assets/workout-01 2.17.36 AM.jpg" data-remote="workout-01 2.17.36 AM.jpg" data-fallback="assets/workout-01.jpg" alt="Athletic"></div>
    <div class="text">
      <div class="stack container">
        ...
        <div class="feature">
          ...
          <img loading="lazy" referrerpolicy="no-referrer" class="remote" src="assets/yoga_pic.jpeg" data-remote="feature-1.jpg" data-fallback="assets/workout-02.jpg" alt="Strength">
        </div>
        <div class="divider"></div>
        <div class="feature">
        ...
        <div class="feature">
          ...
          <img loading="lazy" referrerpolicy="no-referrer" class="remote" src="assets/pickleball-6940609_960_720.jpeg" data-remote="spa.jpg" data-fallback="assets/pickleball-6940609_960_720.jpeg" alt="Spa">
        </div>
        <div class="divider"></div>
  ...
  <section class="bleed" data-reveal>
    <img loading="lazy" referrerpolicy="no-referrer" class="remote" src="assets/54A9B418-5FB3-4CEE-B321-6AE091502384_1_105_c.jpeg" data-remote="work.jpg" data-fallback="assets/workout-05.jpg" alt="WORK">
    <div class="inner">
      <h1>TRAIN</h1>
  ...
  <section class="tiles" data-reveal>
    ...
    <div class="container tile-grid">
      <article class="tile">
        <img loading="lazy" referrerpolicy="no-referrer" class="remote" src="assets/4D288153-7690-43EE-A7C6-489BA52C9E9B_1_105_c.jpeg" data-remote="digital.jpg" data-fallback="assets/workout-06.jpg" alt="Digital">
      ...
      <article class="tile">
        <img loading="lazy" referrerpolicy="no-referrer" class="remote" src="assets/E7311795-3C28-46CD-A5C3-9934B0B2181C_1_105_c.jpeg" data-remote="living.jpg" data-fallback="assets/workout-07.jpg" alt="Living">
  ...
  <section class="amen" data-reveal>
    ...
    <div class="container grid6">
      ...
      <img loading="lazy" referrerpolicy="no-referrer" class="remote" src="assets/box-1514845_960_720.jpeg" data-remote="cafe.jpg" data-fallback="assets/box-1514845_960_720.jpeg" alt="Café">
