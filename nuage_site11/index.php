...
/* === OT layout inline (ensures it loads even if external CSS fails) === */
:root{ --navy:#002D72; --coral:#EB1F48; --ink:#111418; --muted:#6a6d74; --line:#e9e6e1; --bone:#faf7f2; }
...
.hero-ot{min-height:72vh;display:grid;place-items:center;text-align:center;color:#fff;background:radial-gradient(100% 80% at 50% 20%, rgba(235,31,72,.35), rgba(0,45,114,.9)), url('assets/hero.jpg') center/cover no-repeat;}
...
.closing-ot{padding:3rem 1rem;text-align:center;color:#fff;background:linear-gradient(180deg, var(--coral) 0%, var(--navy) 100%)}
