...
<div id="appModal" class="modal" style="display:none;">
  <div class="modal-content">
    ...
    <p>Please download the Glofox app, search NuAge Fitness Studio and register.<br>
    ...
    Type A for Apple<br>
    Type G for Google</p>
    <input type="text" id="choiceInput" placeholder="Enter A or G" style="width:100%;padding:8px;margin-top:10px;">
    <button onclick="submitChoice()" style="margin-top:12px;">Submit</button>
  </div>
</div>
